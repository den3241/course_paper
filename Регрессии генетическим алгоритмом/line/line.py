...
from itertools import product # Библиотека для упрощения работы с перестановками
import matplotlib.pyplot as plt
import numpy


# Входные точки для регрессии
...
def fit(num): # Фитнес-функция
    ...
    summ = 0
    for i in range(numpoints):
        summ = summ + (afact * x[i] + bfact - y[i])**2
    return 10000 - summ
...
for z in range(e): # Пробег по эпохам для поиска лучшего значения
    ...
    print(f'Фитнес-функция: {maxpopp}') # Вывод максимальной фитнес функции для текущей эпохи
